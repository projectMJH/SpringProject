...
<!-- 
 ...
 -->
    <input type="checkbox" value="name" name="fd">업체명
    <input type="checkbox" value="address" name="fd">주소
    <input type="checkbox" value="type" name="fd">음식종류
    <input type="checkbox" value="theme" name="fd">테마 
