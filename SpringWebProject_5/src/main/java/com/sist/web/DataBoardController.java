 ...
 * 						| 무료 (오픈 소스) => 개발시간 단축 => MVC 동작 기본틀 => 기능만 구현
 ...
 * 							   ----------------------------
 * 
 * 						2. AOP => 필요시마다 공통된 기능을 모아서 관리 => 자동 호출이 가능
 * 						   		  | 소스 중복 제거, 공통으로 적용 => 자동화 처리	
 * 						   		  => 어떤 메서드에서 적용 | 메서드 어느 영역인지 	
 * 						   		  	 --------------   ---------------
 * 									 | PointCut		   | JoinPoint	 	
 * 														 @Before => aaa()
 * 														 @After => bbb()
 ...
 * 														 @Around => eee()
 * 									 -------------------------------- Advice	 	
 * 									   PintCut => execution("* 패키지.클래스명.메서드명(매개변수..)")	 	
 * 									   						-- 리턴형       ----- *, 시작*	 	
 * 									   						-- 매개변수 : .. (0개 이상)	 
 * 									   => Controller에서 적용	
...
public class DataBoardController {
	...
	public String databoard_list(String page,Model model)
	{
		...
		List<DataBoardVO> list=dDao.boardListData(start, end);
